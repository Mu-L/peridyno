...
namespace dyno
{
	...
	class Animation2JointConfigTuple : public Tuple
	{
	public:

		Animation2JointConfigTuple() {}
		Animation2JointConfigTuple(std::string name, int id, uint axis)
		{
			this->varJointName()->setValue(name);
			this->varJointId()->setValue(id);
			this->varAxis()->setValue(axis);
		}
		Animation2JointConfigTuple(std::string name, int id, uint axis, float intensity)
		{
			this->varJointName()->setValue(name);
			this->varJointId()->setValue(id);
			this->varAxis()->setValue(axis);
			this->varIntensity()->setValue(intensity);
		}
		Animation2JointConfigTuple& operator=(Animation2JointConfigTuple& other) {
